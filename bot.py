...
async def get_analytics_report(days=7):
    ...
    try:
        ...
        return {
            ...
            'posts': posts_count, 'new_users': new_users, 'new_content': new_content,
            'notifications': notifications_sent, 'channel_stats': channel_stats, 'category_stats': category_stats
        }
    finally:
        session.close()
